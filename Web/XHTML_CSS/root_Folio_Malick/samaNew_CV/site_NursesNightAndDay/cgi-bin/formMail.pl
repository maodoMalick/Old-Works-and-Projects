...
BEGIN
{
  ...
  $allow_empty_ref   = 1;
  $max_recipients    = 5;
  $mailprog          = '/usr/sbin/sendmail -oi -t -f service@nursesnightandday.com';
  $postmaster        = '';
  @referers          = qw(nursesnightandday.com);
  @allow_mail_to     = qw(service@nursesnightandday.com);
  @recipients        = ();
  %recipient_alias   = ();
...
From: service@nursesnightandday.com
